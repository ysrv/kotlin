...
fun case_7(value_1: Any?, value_2: Any?) {
    if (case_7_1(value_1)) {
        value_1.<!UNRESOLVED_REFERENCE!>length<!>
        if (case_7_2(value_1)) value_1.<!UNRESOLVED_REFERENCE!>length<!>
    }
    if (!case_7_3(value_2)) {
        value_2.<!UNRESOLVED_REFERENCE!>length<!>
        if (!case_7_4(value_2)) value_2.<!UNRESOLVED_REFERENCE!>length<!>
    }
    ...
    if (case_7_7(value_2) == null) {
        value_2.<!UNRESOLVED_REFERENCE!>length<!>
        if (case_7_8(value_2) == null) value_2.<!UNRESOLVED_REFERENCE!>length<!>
    }
}
...
fun case_8(value_1: Any?, value_2: Any?) {
    ...
    if (!case_8_4(value_2)) {
        ...
        if (<!UNRESOLVED_REFERENCE!>!<!><!INAPPLICABLE_CANDIDATE!>case_8_5<!>(value_2)) {
            value_2.<!UNRESOLVED_REFERENCE!>toByte<!>()
            if (<!UNRESOLVED_REFERENCE!>!<!><!INAPPLICABLE_CANDIDATE!>case_8_6<!>(value_2)) value_2.inv()
        }
    }
    ...
    if (case_8_10(value_2) == null) {
        value_2?.<!UNRESOLVED_REFERENCE!>toByte<!>()
        if (<!INAPPLICABLE_CANDIDATE!>case_8_11<!>(value_2) == null) {
            value_2.<!UNRESOLVED_REFERENCE!>toByte<!>()
            if (<!INAPPLICABLE_CANDIDATE!>case_8_12<!>(value_2) == null) value_2.inv()
        }
    }
}
