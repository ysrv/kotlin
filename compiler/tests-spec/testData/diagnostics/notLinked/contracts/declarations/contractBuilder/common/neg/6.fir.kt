...
object case_1 {
    ...
    fun case_1_1(): Boolean? {
        contract { returnsNotNull() implies (value_1) }
        return if (value_1) true else null
    }
    fun case_1_2(): Boolean? {
        contract { returns(null) implies (value_2) }
        return if (value_2) null else true
    }

    fun case_1_3(): Boolean {
        contract { returns(true) implies (value_3) }
        return value_3
    }
}
...
class case_2(value_5: Boolean, val value_1: Boolean) {
    ...
    fun case_2_2(): Boolean? {
        contract { returns(null) implies (value_1) }
        return if (value_1) null else true
    }

    fun case_2_3(): Boolean {
        contract { returns(true) implies (value_2) }
        return value_2
    }

    fun case_2_4(): Boolean {
        contract { returns(false) implies (value_3) }
        return !(value_3)
    }

    inline fun <reified K : Number> K.case_2_5(): Boolean? {
        contract { returnsNotNull() implies (value_4) }
